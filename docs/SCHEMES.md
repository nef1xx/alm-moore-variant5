...
![Исходная блок-схема](../diagrams/01_flowchart.png)
...
![Отмеченная ГСА с остановкой в S6](../diagrams/04_marked_gsa.png)

## Учебная циклическая отмеченная ГСА

![Учебная циклическая отмеченная ГСА](../diagrams/04b_marked_gsa_cyclic.png)
...
![Граф с учётом достижимых F(X)](../diagrams/05b_moore_reachable.png)

## Учебный циклический граф Мура

![Учебный циклический граф Мура](../diagrams/05c_moore_cyclic.png)
...
![Схема формирования F1,F2,F3](../diagrams/07_input_logic.png)

## Общая аппаратная схема

![Общая аппаратная схема](../diagrams/08a_hardware_overview.png)
...
![Логика переходов](../diagrams/08c_transition_logic.png)

## Функции возбуждения RS и альтернативные D

![Функции возбуждения RS и альтернативные D](../diagrams/08d_excitation_logic.png)

## Три синхронных RS-триггера

![Три синхронных RS-триггера](../diagrams/08e_register.png)

## Формирование Y и DONE

![Формирование Y и DONE](../diagrams/08f_output_logic.png)

## Временная диаграмма тестового сценария

![Временная диаграмма тестового сценария](../diagrams/09_timing.png)
